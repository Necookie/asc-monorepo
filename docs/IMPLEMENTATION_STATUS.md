...
| **Phase 6: Public Website** | `IN PROGRESS` | `feature/public-community` | `apps/web/app/(public)/*`, `/[slug]/page.tsx` | Route & privacy tests | None | Homepage, directory, profile pages |
