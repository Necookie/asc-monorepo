          ...
          <div className="flex flex-col sm:flex-row items-start gap-6 pt-2">
            ...
            <div className="relative shrink-0 mx-auto sm:mx-0">
              ...
              {activeMember.isSupporter && (
                <div
                  className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-[#141843] border-2 border-[#ec48bd] flex items-center justify-center text-[#ec48bd] shadow-md"
            ...
            <div className="flex-1 min-w-0 space-y-4 text-center sm:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                ...
                <span className="text-xs text-slate-400 font-medium px-2.5 py-1 rounded-lg bg-white/5 border border-white/5">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-1.5 pt-1">
                {activeMember.tags.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium text-slate-300 bg-white/5 border border-white/5 hover:border-white/10 transition-colors"
                  >
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pt-3 border-t border-white/10">
                <div className="flex items-center gap-3">
                  {activeMember.links.map((link) => (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#00b0f4] hover:text-white transition-colors"
                    >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1 text-xs font-semibold text-white hover:text-[#5865f2] transition-colors"
                >
